...
extern signed int vspInitHorse; // Address: 0x2E7B7C
// Size: 0x5C, DWARF: 0xA143A
extern VspModeData vspModeData; // Address: 0x3BF620
extern signed int vspEndRun; // Address: 0x2E7B84
// Size: 0x5640, DWARF: 0xA2464
extern Rider* vspRider[8]; // Address: 0x3BD480
// Size: 0xA0, DWARF: 0xA49D0
extern VspenvGame* vspenvGame; // Address: 0x2E7B14
extern signed int vspDisp2D; // Address: 0x2E77F0

static char* vktmfMenuText[2][3] = {
    { "CONTINUE", "RESTART", "EXIT" },
    { "CONTINUE", "RETIRE", "EXIT" },
}; // Address: 0x2B5800
static signed int(* vktmfMenuFunc[2][3])(signed int) = {
    { ktmfMenuFunc_continue, ktmfMenuFunc_restart, ktmfMenuFunc_exit },
    { ktmfMenuFunc_continue, ktmfMenuFunc_retire, ktmfMenuFunc_exit },
}; // Address: 0x2B5820
static signed int vktmfMenuUseNum[3] = { 0, 0, 0 }; // Address: 0x2B5838
static signed int vktmfMenuMinMax[3][2] = { { 0, 0 }, { 0, 0 }, { 0, 0 } }; // Address: 0x2B5850
static char* vktmfdbgMenuText2[2] = { "Finish", "2D" }; // Address: 0x2E77C8
static signed int(* vktmfdbgMenuFunc2[2])(signed int) = { ktmfMenuFunc_finish, ktmfdbgMenuFunc_2d }; // Address: 0x2E77D0
static signed int vktmfdbgMenuUseNum2[2] = { 0, 1 }; // Address: 0x2E77D8
static signed int vktmfdbgMenuMinMax2[2][2] = { { 0, 0 }, { 0, 1 } }; // Address: 0x2B5870
static char* vktmfdbgMenuNumText_2d[2] = { "ON", "OFF" }; // Address: 0x2E77E0
