...
static void spInitRiderDisp(Disp *rdd, void *umd, void *utd, Seq *seq,
                            signed int pid, signed int rid, Cheats *cheats);
...
void ulFree(void *p);
void ktactGetRotVector(float *rot, float *pole, float rot_pole,
                       signed int flag);
...
void spRiderSetPos2(Rider *rider, sceVu0FVECTOR pos, float roty) {
  ...
  float nor[4] = {0.0f, -1.0f, 0.0f, 0.0f}; // 0x50(r29)
  s32 *nor_ptr = &nor;
