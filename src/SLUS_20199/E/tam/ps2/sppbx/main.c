...
// Size: 0x20, DWARF: 0x22B0
extern VspenvDemo vspenvDemo; // Address: 0x3473D0
extern signed int _stack[]; // Address: 0x1FF0000
extern signed int _end[]; // Address: 0x3C9900

// Initialised data is emitted in declaration order, so these ascend by address.

static signed int vgmsysScrMode = -1; // Address: 0x2E7700
signed int vsppScrWidth = 640; // Address: 0x2E7704
signed int vsppScrHeight = 224; // Address: 0x2E7708
static signed int vsppMediaType = 1; // Address: 0x2E770C

static void(* vgmsysSetScreenMode[3])() = {
    gmsysSetScrMode__normal,
    gmsysSetScrMode__anti_alias,
    gmsysSetScrMode__depth_of_field,
}; // Address: 0x2B2DF0
...
static signed int vgmsysBlurPow; // Address: 0x2E79A8
static signed int vgmsysWndBlurPow[2]; // Address: 0x2E79A0
...
signed int vgmsysNextScrMode; // Address: 0x2E7980, crt0 clears bss from here

// Size: 0x14, DWARF: 0x4238
static VgmsysGifPktBuff _vgmsysGifPkt; // Address: 0x2EF2C0
// Size: 0x20, DWARF: 0x1F1C
static VgmsysVif1Pkt _vgmsysVif1Pkt; // Address: 0x2EF2A0
// Size: 0x790, DWARF: 0x447F
    ...
    while (1) {
        ...
        *GIF_CTRL = 1;
        if (ulmov2IsPlaying() == 0) {
            if (vgmsysNextScrMode != vgmsysScrMode) {
                vgmsysSetScreenMode[vgmsysNextScrMode]();
                ...
                vgmsysScrMode = vgmsysNextScrMode;
            } else {
